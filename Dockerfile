...
RUN Rscript -e "install.packages(c('gap', 'bdsmatrix', 'doMC', 'qqman', 'RColorBrewer'))"
RUN Rscript -e "install.packages(c('cli','gh'))"
RUN Rscript -e "install.packages(c('usethis', 'devtools')); devtools::install_github('andreyshabalin/ramwas')"
